...
ActiveRecord::Schema.define(version: 20140516135347) do
  ...
  create_table "banners", force: true do |t|
    ...
    t.boolean  "dark_text",   default: false
  end
  ...
  create_table "deliverables_portfolios", id: false, force: true do |t|
    t.integer "portfolio_id"
    t.integer "deliverable_id"
  end

  add_index "deliverables_portfolios", ["deliverable_id", "portfolio_id"], name: "index_deliverables_portfolios_on_deliverable_and_portfolio", using: :btree
  add_index "deliverables_portfolios", ["portfolio_id", "deliverable_id"], name: "index_deliverables_portfolios_on_portfolio_and_deliverable", using: :btree
  ...
  create_table "markets_portfolios", id: false, force: true do |t|
    t.integer "portfolio_id"
    t.integer "market_id"
  end

  add_index "markets_portfolios", ["market_id", "portfolio_id"], name: "index_markets_portfolios_on_market_and_portfolio", using: :btree
  add_index "markets_portfolios", ["portfolio_id", "market_id"], name: "index_markets_portfolios_on_portfolio_and_market", using: :btree
  ...
  create_table "portfolios_project_types", id: false, force: true do |t|
    t.integer "portfolio_id"
    t.integer "project_type_id"
  end

  add_index "portfolios_project_types", ["portfolio_id", "project_type_id"], name: "index_portfolios_project_types_on_portfolio_and_project_type", using: :btree
  add_index "portfolios_project_types", ["project_type_id", "portfolio_id"], name: "index_portfolios_project_types_on_project_type_and_portfolio", using: :btree

  create_table "portfolios_services", id: false, force: true do |t|
    t.integer "portfolio_id"
    t.integer "service_id"
  end

  add_index "portfolios_services", ["portfolio_id", "service_id"], name: "index_portfolios_services_on_portfolio_and_service", using: :btree
  add_index "portfolios_services", ["service_id", "portfolio_id"], name: "index_portfolios_services_on_service_and_portfolio", using: :btree

  create_table "portfolios_tenon_pages", force: true do |t|
    t.integer  "page_id"
    t.integer  "portfolio_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "portfolios_tenon_pages", ["page_id", "portfolio_id"], name: "index_portfolios_tenon_pages_on_tenon_page_and_portfolio", using: :btree
  add_index "portfolios_tenon_pages", ["portfolio_id", "page_id"], name: "index_portfolios_tenon_pages_on_portfolio_and_tenon_page", using: :btree

  create_table "post_portfolios", force: true do |t|
    t.integer  "post_id"
    t.integer  "portfolio_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "post_portfolios", ["portfolio_id", "post_id"], name: "index_post_portfolios_on_portfolio_id_and_post_id", using: :btree
  add_index "post_portfolios", ["post_id", "portfolio_id"], name: "index_post_portfolios_on_post_id_and_portfolio_id", using: :btree
