...
class DefaultRecord extends React.Component {
  render() {
    const { edit_path, title, delete_path, onDelete, expanded, onToggleExpand } = this.props;
      ...
      <li className={classNames.join(' ')}>
        ...
        <div className="record__expanded-content">
          ...
          <div className="record__expanded-actions">
            <a className="record__expanded-action-text" href={edit_path} title="Action Link">
              Edit Link
            </a>
            <a className="record__expanded-action-text" href="#" title="Another Link">
              Another Link
            </a>
          </div>
        </div>
