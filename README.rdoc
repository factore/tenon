...
(This section glosses over the process of adding and editing components to the ResourceIndex app.  Make sure you read {Using and Customizing the ResourceIndex React App}[#label-Using+and+Customizing+the+ResourceIndex+React+App] before reading this.)
