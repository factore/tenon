...
<tt>sort(field, direction)</tt>:: Used to order your scope by +field+ in +direction+, eg. <tt>sort('books.title', 'asc')</tt>.  Define a method called +allowed_sort_fields+ on your Filterer and return an array of allowed fields, eg. <tt>['books.title', 'created_at', 'authors.title']</tt>.  Direction must be <tt>'asc'</tt> or <tt>'desc'</tt>.
